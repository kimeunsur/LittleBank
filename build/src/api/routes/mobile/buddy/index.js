...
exports.deleteBuddy = exports.putBuddy = exports.getBuddiesNews = exports.getBuddySearch = exports.getBuddies = exports.postBuddy = void 0;
const default_1 = require("../../default");
const buddyCtrl_1 = require("./buddyCtrl");
const postBuddy = new default_1.ApiRouter({
    name: '',
    method: 'post',
    summary: '친구 추가',
    description: `
  ...
  `,
    ...
    handler: buddyCtrl_1.buddyCtrl.postBuddy
});
exports.postBuddy = postBuddy;
const getBuddiesNews = new default_1.ApiRouter({
    name: 'news',
    method: 'get',
  ...
  `,
    ...
    handler: buddyCtrl_1.buddyCtrl.getBuddiesNews
});
exports.getBuddiesNews = getBuddiesNews;
const getBuddies = new default_1.ApiRouter({
    name: '',
    method: 'get',
    summary: '친구 조회',
    description: `
  ...
  `,
    ...
    handler: buddyCtrl_1.buddyCtrl.getBuddies
});
exports.getBuddies = getBuddies;
const getBuddySearch = new default_1.ApiRouter({
    name: 'search',
    method: 'get',
    summary: '친구 찾기',
    description: `
  ...
  `,
    ...
    handler: buddyCtrl_1.buddyCtrl.getBuddySearch
});
exports.getBuddySearch = getBuddySearch;
const putBuddy = new default_1.ApiRouter({
    name: ':id',
    method: 'put',
    summary: '친구 표기이름 수정',
    description: `
  ...
  `,
    ...
    handler: buddyCtrl_1.buddyCtrl.putBuddy
});
exports.putBuddy = putBuddy;
const deleteBuddy = new default_1.ApiRouter({
    name: ':id',
    method: 'delete',
    summary: '친구 삭제',
    description: `
  ...
  `,
    ...
    handler: buddyCtrl_1.buddyCtrl.deleteBuddy
});
